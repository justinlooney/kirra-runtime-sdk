...
| KIRRA-OCCY-AOU-001 | Assumptions of Use register (SEooC AoU / SRAC; central register of cross-cutting deployment-precondition assumptions; first entry AOU-PERCEPTION-FRAME-001 — upstream object velocity is absolute map/world-frame; OPEN pre-enable gate for KIRRA_PERCEPTION_DERATE_ENABLED) | 0.1 | Draft | docs/safety/ASSUMPTIONS_OF_USE.md | 2026-06-04 |
...
| KIRRA-OCCY-PMON-004 | Perception-derate validation gate, SIM tier (operationalizes PMON-003 §D4; mechanism-first split — sub-gate 1 synthetic-publisher mechanism+freshness now, sub-gate 2 AWSIM frame deferred; scenarios (a)-(e) with confirmed step-table cap values; earns KIRRA_PERCEPTION_DERATE_ENABLED in sim only; AOU-PERCEPTION-FRAME-001 stays OPEN until sub-gate 2) | 0.1 | Draft | docs/safety/OCCY_PERCEPTION_DERATE_VALIDATION_GATE.md | 2026-06-04 |
