...
| KIRRA-OCCY-AOU-001 | Assumptions of Use register (SEooC AoU / SRAC; cross-cutting deployment-precondition assumptions). Entries: AOU-PERCEPTION-FRAME-001 (object velocity absolute map/world-frame; OPEN pre-enable gate for KIRRA_PERCEPTION_DERATE_ENABLED); AOU-MSG-TOOLCHAIN-001 (full-message-set codegen — **SUPERSEDED** 2026-06-05 option C, discharged for TOPO-1 via the curated interface / KIRRA-OCCY-MSGSYNC-001); AOU-MSG-TOOLCHAIN-002 (co-resident-with-full-Autoware r2r codegen residual; OPEN) | 0.1 | Draft | docs/safety/ASSUMPTIONS_OF_USE.md | 2026-06-05 |
