...
| SG8 | `crates/kirra-ros2-adapter/src/config.rs:176` | mrc-derated-contract-shape | to_mrc_kinematics_contract_keeps_geometry_swaps_dynamic |
...
| SG9 | `crates/kirra-ros2-adapter/src/node.rs:406` | subscription-liveness | test_stale_subscription_mrcs |
